<div class="SubmitBox">
    ...
    <div class="sections">
        <section>
            ...
            <div class="InputTags">
                <div class="input-button"><input placeholder="태그를 입력하세요" value="">
            ...
            <div class="WriteConfigureThumbnail">
                ...
                <div class="thumbnail-area"><img class="full" src="" alt="post-thumbnail">
                    <div class="overlay full"><button class="white-button"><svg fill="currentColor" preserveAspectRatio="xMidYMid meet"
                                ...
                                <g>
                                    <path d="m20 30v-5l6.6 6.6-6.6 6.8v-5c-7.3 0-13.4-6.1-13.4-13.4 0-2.6 0.8-5.1 2.2-7.1l2.4 2.4c-0.8 1.4-1.2 3-1.2 4.7 0 5.5 4.5 10 10 10z m0-23.4c7.3 0 13.4 6.1 13.4 13.4 0 2.6-0.8 5.1-2.1 7.1l-2.5-2.4c0.8-1.4 1.2-3 1.2-4.7 0-5.5-4.5-10-10-10v5l-6.6-6.6 6.6-6.8v5z"></path>
                                </g>
                            </svg>
    ...
    <div class="footer">
        <div class="buttons"><button class="gray">임시저장</button><button class="purple">작성하기</button></div>
        <div class="open-options"><a>추가설정</a></div>
    </div>
</div>
